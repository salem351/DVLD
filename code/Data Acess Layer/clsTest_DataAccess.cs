...
namespace DVLD_MyDataAccess
{
    ...
    ref string Notes, ref int CreatedByUserID)
        ...
        //    SqlConnection connection = new SqlConnection(clsDataAccessSettings.ConnectionString);
        //    string query = @"use DVLD INSERT INTO Tests(TestAppointmentID, TestResult, Notes, CreatedByUserID) 
        ...
        //public static bool IsApplicantPass(int TestAppointmentID)
        //{
        //    //int RowsAffected = 0;
        //    bool IsExist = false;

        //    SqlConnection connection = new SqlConnection(clsDataAccessSettings.ConnectionString);
        //    string query = @"use DVLD Select found = 1 from Tests
        ...
        //    return IsExist;
        //}
        //public static bool IsApplicantFail(int TestAppointmentID)
        //{
        //    //int RowsAffected = 0;
        //    bool IsExist = false;
